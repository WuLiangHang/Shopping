  ...
  <tr>
    ...
    <td width="618" align="center" valign="top" bgcolor="#FFFFFF"> <br>
        ...
        <table width="610" height="25" border="0" cellpadding="0" cellspacing="0" background="image/bg_02.jpg">
          <tr>
            <td><div align="center"><strong>修改商品信息</strong></div></td>
          </tr>
        </table>
        <br>

  <form action="goodsAction.do?action=19" method="post" enctype="multipart/form-data"  name="form" onSubmit="return checkEmpty(form)" >
        <table width="90%"  border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td bgcolor="#FFFFFF">&nbsp;&nbsp;
            <input name="name" type="text" size="20" value="<%= goodsForm.getName()%>"></td>
            <td>&nbsp;&nbsp;生产厂商</td>
            <td bgcolor="#FFFFFF">&nbsp;
            <input name="from" type="text" size="20" value="<%=goodsForm.getFrom()%>" ></td>
          </tr>
          <tr>
            <td height="27">&nbsp;&nbsp;商品定价</td>
            <td bgcolor="#FFFFFF">&nbsp;&nbsp;
            <input name="nowPirce" type="text" size="20" value="<%=goodsForm.getNowPrice()%>"></td>
            <td>&nbsp; 特价</td>
            <td bgcolor="#FFFFFF">&nbsp;
            <input name="freePirce" type="hidden" size="20" value="<%=goodsForm.getFreePrice() %>"><%=goodsForm.getFreePrice() %>元</td>
          </tr>
          ...
          <tr>
            <td height="28">&nbsp;&nbsp;简介</td>
            <td colspan="3" bgcolor="#FFFFFF">&nbsp;&nbsp;
            <input name="introduce" type="text" size="50" value="<%=goodsForm.getIntroduce()%>">
            <input name="member" type="text" style="display:none;" value="<%=((MemberForm)session.getAttribute("form")).getName() %>" />
            </td>
          </tr>
        </table><br>
