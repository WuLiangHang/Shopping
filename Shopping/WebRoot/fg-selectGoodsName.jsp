...
<%if(list.size()==0){%><br><br><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;没有商品的信息<br><br><br><br><%}else{%>
           <%
              for(int i=start;i<over;i++){
              GoodsForm goodForm=(GoodsForm)list.get(i);
            %>
<br>
		<table width="67%"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#819BBC">
          <tr>
            <td width="36%" rowspan="4" height="120"><input name="pricture<%=i%>" type="image" src="<%=goodForm.getPriture()%>" width="140" height="126"></td>
            <td width="64%" height="30"><div align="center"><%=goodForm.getName()%></div></td>
          </tr>
          <tr>
            <td height="30"><div align="center">
            <%if(goodForm.getMark().toString().equals("0")){%>
              单价：<%=goodForm.getNowPrice()%>元
            <%}else{%>
             <font color="#FF0000"> 特价：<%=goodForm.getFreePrice()%>元</font>
            <%}%>
            </div></td>
          </tr>
          <tr>
            <td height="30"><div align="center"><%=goodForm.getIntroduce()%></div></td>
          </tr>
          <tr>
            <td height="30"> <div align="center">  <%if(session.getAttribute("form")!=null||session.getAttribute("id")!=null){%>
              <a href="#" onClick="window.open('goodsAction.do?action=16&id=<%=goodForm.getId()%>','','width=500,height=200');">查看详细内容</a>
