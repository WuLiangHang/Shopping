    ...
    <td width="618" align="center" valign="top" bgcolor="#FFFFFF"> <br>
      ...
      %>
        <tr bgcolor="#FFFFFF">
          ...
          <td><div align="center"><a href="goodsAction.do?action=5&id=<%=form.getId()%>">详情</a>&nbsp;
		 <a href="goodsAction.do?action=19&id=<%=form.getId()%>">修改</a>&nbsp;
	  ...
	  <table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
        <tr align="center">
          ...
          <td width="19%">共有<%=pageNumber%>条记录&nbsp;</td>
          <td width="20%">当前为第<%=number+1%>页</td>
          <td width="17%"><%if((number+1)==1){%>  
	  上一页  
        <%}else{%>
...
<%}%>
         ...
         <%if(!session.getAttribute("isadmin").equals("true")){ %>  
            <div align="right">
            	<img src="image/bg-add.gif" width="9" height="9">&nbsp;<a href="bg-goodInsert.jsp">添加商品</a>&nbsp;
            </div>
          <%} %>   
            </td>
