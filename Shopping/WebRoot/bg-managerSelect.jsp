...
{%>删除<%}%>
   ...
   <tr align="center">
    ...
    <td width="16%"><%if((number+1)==1){%> 上一页<%}else{%><a href="managerAction.do?action=1&i=<%=number-1%>">上一页</a></td><%}%>
            <td width="16%"><%if(maxPage<=(number+1)){%>下一页<%}else{%><a href="managerAction.do?action=1&i=<%=number+1%>">下一页</a></td><%}%>
     <%if(sigh==1){%>
			<td width="20%">	<div align="right"><img src="image/bg-add.gif" width="9" height="9">&nbsp;<a href="bg-managerInsert.jsp">添加管理员</a>&nbsp;&nbsp;&nbsp;&nbsp;</div>
	</td><%}else{%><%}%>
