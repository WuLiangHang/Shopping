        ...
        <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
		 <tr>
          ...
          <table width="167" border="0" align="center">
            ...
            <tr>
              <td height="25"><font size="2"><%=countTime.currentlyTime()%></font></td>
              </tr>
			 <tr>
              ...
              <td height="20" align="right" valign="middle"><a href="orderAction.do?action=6&name=<%=((MemberForm)session.getAttribute("form")).getName() %>">我的店铺</a>&nbsp;<a href="javascript:quit()">安全退出</a></td>
              </tr>	
          </table>
	  </td>
     </tr>
